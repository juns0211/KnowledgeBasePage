...
const I18N = {
  zh: {
    ...
    showcase: {
      ...
      shots: [
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/chat.png", caption: "對話式查詢與檢索結果" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/dept.png", caption: "成員分類管理" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/km.png", caption: "簡單易懂的知識上傳方式" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/km-category.png", caption: "靈活的知識內容分類授權" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/model.png", caption: "靈活支援各類主流模型" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/prompt.png", caption: "靈活提示 AI 思考方式" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/user.png", caption: "透過管理員新增一起使用的用戶" },
      ],
    },
    pricing: {
  ...
  en: {
    ...
    showcase: {
      ...
      shots: [
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/chat.png", caption: "Conversational search & retrieval" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/dept.png", caption: "Member & department management" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/km.png", caption: "Simple knowledge uploads" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/km-category.png", caption: "Flexible category permissions" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/model.png", caption: "Support for major AI models" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/prompt.png", caption: "Shape how the AI thinks" },
        { src: "https://juns0211.github.io/KnowledgeBasePage/assets/user.png", caption: "Invite users via admin" },
      ],
    },
    pricing: {
